...
namespace Chillindo.Tests.Unit
{
    ...
    public partial class AccountRepository_Test
    {
        ...
        public AccountRepository_Test()
        {
            ...
            var options = new DbContextOptionsBuilder<ChillindoContext>()
                .UseInMemoryDatabase(databaseName: "Chillindo")
                .Options;

            using (var context = new ChillindoContext(options, dbLogger.Object))
            {
            ...
            var starWarsContext = new ChillindoContext(options, dbLogger.Object);
